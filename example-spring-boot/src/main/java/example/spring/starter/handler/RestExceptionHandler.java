package example.spring.starter.handler;
...
import example.service.dto.error.ValidationError;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> handleAccessDeniedException(AccessDeniedException rnfe, HttpServletRequest request) {
        ...
        return new ResponseEntity<ErrorDetail>(errorDetail, null, HttpStatus.FORBIDDEN);
    }
